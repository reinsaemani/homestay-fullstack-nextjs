...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="flex h-11 w-11 items-center justify-center rounded-full bg-brand-500 text-sm font-medium text-white">
          {userName.charAt(0).toUpperCase()}
        </span>
        <span className="ml-3 mr-1 hidden text-left sm:block">
